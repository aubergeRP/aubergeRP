...
test-e2e:
	cd tests/e2e && node --test chat-streaming.test.mjs generate-image-button.test.mjs mobile-scroll.test.mjs markdown-rendering.test.mjs admin-mobile.test.mjs admin-config-styling.test.mjs admin-summaries.test.mjs chat-mobile.test.mjs
